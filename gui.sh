...
case $CHOICE2 in
        1)
            cp $S7_PATH/libsnap7_300.so /usr/local/lib/;
            cp $S7_PATH/libsnap7_300.so /usr/lib/;
	    echo "Copied";;
        2)
            echo "Copying library..."
            cp $S7_PATH/libsnap7_400.so /usr/local/lib/;
            cp $S7_PATH/libsnap7_400.so /usr/lib/;
            echo "Copied";;
        3)
